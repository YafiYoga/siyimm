...
<div class="bg-white p-6 rounded-xl shadow-md max-w-6xl mx-auto overflow-auto max-h-[600px] border border-gray-200 font-[Verdana]">
    ...
    <form method="GET" class="mb-6 flex flex-wrap gap-4 items-end">
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('lembaga.absensi_siswa', ['id' => $id]) }}" class="bg-gray-300 text-gray-800 px-5 py-2 rounded shadow hover:bg-gray-400 transition">Reset</a>
            <a 
                href="{{ route('lembaga.absensi_siswa_cetak', array_merge(['id' => $id], request()->only(['tahun_ajaran','semester','kelas','mapel','bulan','tanggal']))) }}" 
                target="_blank"
